...
var generateExternal = async (external) => {
  ...
  for (const item of external) {
    ...
    const deps = await _chunk247V7HL5js.getDeps.call(void 0, pkgPath);
    result.push(...deps);
  }
  return result;
};
async function runEsbuild(options, {
  ...
  const pkg = await _chunk247V7HL5js.loadPkg.call(void 0, process.cwd());
  ...
  if (result && result.warnings && !_chunk247V7HL5js.getSilent.call(void 0, )) {
...
async function build(_options) {
  const config = _options.config === false ? {} : await _chunk247V7HL5js.loadTsupConfig.call(void 0, 
    process.cwd(),
  ...
  await Promise.all(
    [...Array.isArray(configData) ? configData : [configData]].map(
      async (item) => {
        const logger = _chunk247V7HL5js.createLogger.call(void 0, item == null ? void 0 : item.name);
