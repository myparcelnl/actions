...
var _chunkKR6IGADBjs = require('./chunk-KR6IGADB.js');
...
var require_consola = _chunkYAA43YLEjs.__commonJS.call(void 0, {
  "node_modules/.pnpm/consola@2.15.3/node_modules/consola/dist/consola.js"(exports, module) {
    ...
    var D = u(_chunkYAA43YLEjs.__require.call(void 0, "util"));
    var e = _chunkYAA43YLEjs.__require.call(void 0, "path");
    var t = _chunkYAA43YLEjs.__require.call(void 0, "fs");
    var r = u(_chunkYAA43YLEjs.__require.call(void 0, "os"));
    var n = u(_chunkYAA43YLEjs.__require.call(void 0, "tty"));
    function s(u2, D2) {
    ...
    var Gu = "undefined" != typeof __non_webpack_require__ ? __non_webpack_require__ : _chunkYAA43YLEjs.__require;
    var zu = class {
      constructor(u2) {
        if (u2 && u2.log)
          this.logger = u2;
  ...
  return {
    ...
    setup(build2) {
      ...
      const getPostcssConfig = async (file) => {
        const loadConfig = _chunkYAA43YLEjs.__require.call(void 0, "postcss-load-config");
      ...
      build2.onLoad({ filter: /\.css$/ }, async (args) => {
        ...
        if (plugins || plugins.length > 0) {
          const postcss = _chunkYAA43YLEjs.getPostcss.call(void 0, );
          if (!postcss) {
            return {
              errors: [
                {
  ...
  return {
    ...
    setup(build2) {
      ...
      build2.onLoad({ filter: /\.svelte$/ }, async (args) => {
        svelte = svelte || _chunkYAA43YLEjs.localRequire.call(void 0, "svelte/compiler");
        if (!svelte) {
          return {
...
// src/esbuild/index.ts
var import_consola = _chunkYAA43YLEjs.__toESM.call(void 0, require_consola());
...
var swcPlugin = ({ logger }) => {
  return {
    name: "swc",
    setup(build2) {
      const swc = _chunkYAA43YLEjs.localRequire.call(void 0, "@swc/core");
      if (!swc) {
        logger.warn(
  ...
  return {
    ...
    setup(build2) {
      build2.onResolve({ filter: /\.node$/, namespace: "file" }, (args) => {
        const resolvedId = _chunkYAA43YLEjs.__require.resolve(args.path, {
...
var generateExternal = async (external) => {
  ...
  for (const item of external) {
    ...
    const deps = await _chunkNTUJSWRXjs.getProductionDeps.call(void 0, pkgPath);
    result.push(...deps);
  }
  return result;
};
async function runEsbuild(options, {
  ...
  const pkg = await _chunkNTUJSWRXjs.loadPkg.call(void 0, process.cwd());
  ...
  try {
    result = await _esbuild.build.call(void 0, {
      ...
      plugins: esbuildPlugins.filter(_chunkYAA43YLEjs.truthy),
      define: {
  ...
  if (result && result.warnings && !_chunkNTUJSWRXjs.getSilent.call(void 0, )) {
...
var es5 = () => {
  ...
  return {
    ...
    async renderChunk(code, info) {
      ...
      const swc = _chunkYAA43YLEjs.localRequire.call(void 0, "@swc/core");
      if (!swc) {
        throw new (0, _chunkDNFHKOTNjs.PrettyError)(
...
var normalizeOptions = async (logger, optionsFromConfigFile, optionsOverride) => {
  ...
  if (!entry || Object.keys(entry).length === 0) {
    throw new (0, _chunkDNFHKOTNjs.PrettyError)(`No input files, try "tsup <your-file>" instead`);
  }
  if (Array.isArray(entry)) {
    options.entry = await _globby2.default.call(void 0, entry);
    if (!options.entry || options.entry.length === 0) {
      throw new (0, _chunkDNFHKOTNjs.PrettyError)(`Cannot find ${entry}`);
    } else {
    ...
    Object.keys(entry).forEach((alias) => {
      ...
      if (!_fs2.default.existsSync(filename)) {
        throw new (0, _chunkDNFHKOTNjs.PrettyError)(`Cannot find ${alias}: ${filename}`);
      }
    });
    options.entry = entry;
  ...
  if (tsconfig) {
    ...
    throw new (0, _chunkDNFHKOTNjs.PrettyError)(`Cannot find tsconfig: ${options.tsconfig}`);
  }
  if (!options.target) {
...
async function build(_options) {
  const config = _options.config === false ? {} : await _chunkNTUJSWRXjs.loadTsupConfig.call(void 0, 
    process.cwd(),
  ...
  await Promise.all(
    [...Array.isArray(configData) ? configData : [configData]].map(
      async (item) => {
        const logger = _chunkNTUJSWRXjs.createLogger.call(void 0, item == null ? void 0 : item.name);
        const options = await normalizeOptions(logger, item, _options);
        logger.info("CLI", `tsup v${_chunkKR6IGADBjs.version}`);
        if (config.path) {
        ...
        const mainTasks = async () => {
          ...
          if (!((_a = options.dts) == null ? void 0 : _a.only)) {
            ...
            let depsHash = await _chunkNTUJSWRXjs.getAllDepsHash.call(void 0, process.cwd());
            ...
            const debouncedBuildAll = _chunkYAA43YLEjs.debouncePromise.call(void 0, 
              () => {
                return buildAll();
              },
              100,
              _chunkDNFHKOTNjs.handleError
            );
            const buildAll = async () => {
              ...
              if (options.clean) {
                ...
                await _chunkYAA43YLEjs.removeFiles.call(void 0, 
                  ["**/*", "!**/*.d.ts", ...extraPatterns],
                  options.outDir
                );
            ...
            const startWatcher = async () => {
              ...
              watcher.on("all", async (type, file) => {
                file = _chunkYAA43YLEjs.slash.call(void 0, file);
                let shouldSkipChange = false;
                if (options.watch === true) {
                  if (file === "package.json" && !buildDependencies.has(file)) {
                    const currentHash = await _chunkNTUJSWRXjs.getAllDepsHash.call(void 0, process.cwd());
