...
var require_flat = _chunkYAA43YLEjs.__commonJS.call(void 0, {
...
// src/cli-main.ts
var import_flat = _chunkYAA43YLEjs.__toESM.call(void 0, require_flat());
var _fs = require('fs');
...
async function main(options = {}) {
  ...
  cli.command("[...files]", "Bundle files", {
    ...
    default: "cjs"
  }).option("--minify", "Minify bundle").option("--minify-whitespace", "Minify whitespace").option("--minify-identifiers", "Minify identifiers").option("--minify-syntax", "Minify syntax").option(
    "--keep-names",
  ...
  ).option("--define.* <value>", "Define compile-time constants").option("--external <name>", "Mark specific packages / package.json (dependencies and peerDependencies) as external").option("--global-name <name>", "Global variable name for iife format").option("--jsxFactory <jsxFactory>", "Name of JSX factory function", {
    ...
    if (!options.entry && files.length > 0) {
      options.entry = files.map(_chunkYAA43YLEjs.slash);
    }
    if (flags.format) {
