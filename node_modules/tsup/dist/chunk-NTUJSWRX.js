...
var init_vlq = _chunkYAA43YLEjs.__esm.call(void 0, {
  "node_modules/.pnpm/vlq@0.2.3/node_modules/vlq/src/vlq.js"() {
    charToInteger = {};
    integerToChar = {};
...
_chunkYAA43YLEjs.__export.call(void 0, magic_string_es_exports, {
  Bundle: () => Bundle,
...
var init_magic_string_es = _chunkYAA43YLEjs.__esm.call(void 0, {
  "node_modules/.pnpm/magic-string@0.22.5/node_modules/magic-string/dist/magic-string.es.js"() {
    init_vlq();
    Chunk.prototype = {
...
var require_dist = _chunkYAA43YLEjs.__commonJS.call(void 0, {
  "node_modules/.pnpm/rollup-plugin-hashbang@2.2.2/node_modules/rollup-plugin-hashbang/dist/index.js"(exports, module) {
    ...
    var fs2 = _interopDefault(_chunkYAA43YLEjs.__require.call(void 0, "fs"));
    var path2 = _interopDefault(_chunkYAA43YLEjs.__require.call(void 0, "path"));
    var MagicString = _interopDefault((init_magic_string_es(), _chunkYAA43YLEjs.__toCommonJS.call(void 0, magic_string_es_exports)));
    function _async(f) {
      return function() {
...
var loadJson = async (filepath) => {
  try {
    return _chunkYAA43YLEjs.jsoncParse.call(void 0, await _fs2.default.promises.readFile(filepath, "utf8"));
  } catch (error) {
...
var colorize = (type, data, onlyImportant = false) => {
  ...
  return _chunkDNFHKOTNjs.colorette_exports[color](data);
};
var makeLabel = (name, input, type) => {
  return [
    name && `${_chunkDNFHKOTNjs.dim.call(void 0, "[")}${name.toUpperCase()}${_chunkDNFHKOTNjs.dim.call(void 0, "]")}`,
...
var reportSize = (logger, format, files) => {
  ...
  for (const name of filenames) {
    logger.success(
      format,
      `${_chunkDNFHKOTNjs.bold.call(void 0, padRight(name, maxLength))}${_chunkDNFHKOTNjs.green.call(void 0, 
